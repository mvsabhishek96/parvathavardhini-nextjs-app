...
// Step 1: Import our new user store
...
export default function LoginForm() {
  ...
  // Step 2: Get the 'setUser' action from our store
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Step 3: On success, update the global store instead of showing an alert
  ...
  return (
    // The HTML part of the form remains exactly the same
